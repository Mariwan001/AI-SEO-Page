...
export const Hero = () => {
  ...
  return( 
    ...
    animate={{backgroundPosition: starsBg.width}}
    ...
    >
      ...
      <div className=" container relative mt-16">
        ...
        <p className="text-lg md:text-xl text-white/70 mt-5 text-center max-w-xl mx-auto">Elevate your site visibility effortlessly with AI, where smart technology meets user-friendly SEO tools.</p>
