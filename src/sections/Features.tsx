...
const FeatureTab = (props: (typeof tabs)[number] & ComponentPropsWithoutRef<'div'> & { selected: boolean }) => {
  ...
  return (
    <div
    ref={tabRef}
     onMouseEnter={handleTabHover} className=" text-center border border-white/15 flex p-2.5 rounded-xl gap-2.5 items-center lg:flex-1 relative"
    ...
    <div className="h-12 w-12 border border-white/15 p-2.5 rounded-lg inline-flex items-center justify-center">
  ...
  return <section className="py-20 md:py-24">
    <div className=" container">
        ...
        {tabs.map((tab, tabIndex) => (
            <FeatureTab {...tab} selected={selectedTab === tabIndex} key={tab.title} onClick={() => handleSelectTab(tabIndex)}/>
            ))}
        </div>
